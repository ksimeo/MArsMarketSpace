...
<script type="text/javascript">
    ...
    function pressButtonEditUserList() {
        document.location = "/newuser.do";
    }

    function pressButtonEditProdList() {
        document.location = "/prodedit.do?tid=0&gid=0";
    }
...
<p>
    ...
    <input type="button" value="Редактировать список пользователей" onclick="pressButtonEditUserList()"/>
...
<table>
    ...
    <c:forEach var="item" items="${orders}">
        <tr>
            <form action="/consider.do" method="get">
                <td>${item.id}</td>
